...
....
include::https://raw.githubusercontent.com/TommyJ1994/mobile-security-android-template/3270aaca4249a18a6c71d43e2e6f0f130f3fb0bb/app/src/main/assets/mobile-services.json[]
....

The redirect url of the application is defined in `android.defaultConfig.manifestPlaceholders` of the apps build.gradle[https://github.com/feedhenry/mobile-security-android-template/blob/master/app/build.gradle] file.
...
....
include::https://raw.githubusercontent.com/TommyJ1994/mobile-security-android-template/3270aaca4249a18a6c71d43e2e6f0f130f3fb0bb/app/src/main/java/com/feedhenry/securenativeandroidtemplate/di/SecureApplicationModule.java[tags=authServiceInit]
....
...
app/src/main/java/com/feedhenry/securenativeandroidtemplate/di/SecureApplicationModule.java
.Code
[source,java,linenums,indent=0]
....
include::https://raw.githubusercontent.com/TommyJ1994/mobile-security-android-template/3270aaca4249a18a6c71d43e2e6f0f130f3fb0bb/app/src/main/java/com/feedhenry/securenativeandroidtemplate/features/authentication/providers/KeycloakAuthenticateProviderImpl.java[tags=login]
....
...
[source,java,linenums,indent=0]
....
include::https://raw.githubusercontent.com/TommyJ1994/mobile-security-android-template/3270aaca4249a18a6c71d43e2e6f0f130f3fb0bb/app/src/main/java/com/feedhenry/securenativeandroidtemplate/MainActivity.java[tags=onActivityResult]
....
...
[source,java,linenums,indent=0]
....
include::https://raw.githubusercontent.com/TommyJ1994/mobile-security-android-template/3270aaca4249a18a6c71d43e2e6f0f130f3fb0bb/app/src/main/java/com/feedhenry/securenativeandroidtemplate/features/authentication/providers/KeycloakAuthenticateProviderImpl.java[tags=logout]
....
...
The Keycloak server config is defined in the https://raw.githubusercontent.com/feedhenry/mobile-security-ios-template/master/secure-ios-app/AppConfig.plist[secure-ios-app/AppConfig.plist] file.

.Code
[source,swift,linenum,indent=0]
....
include::https://raw.githubusercontent.com/feedhenry/mobile-security-ios-template/master/secure-ios-app/AppConfig.plist[]
....

The `performAuthentication()` function handles the user authentication flow and the backchannel token exchange.

.Code
[source,swift,linenum,indent=0]
....
include::https://raw.githubusercontent.com/feedhenry/mobile-security-ios-template/master/secure-ios-app/services/AuthenticationService.swift[tags=performAuthentication]
....

The `isLoggedIn()` can be used to check if the user is authenticated.

.Code
[source,swift,linenum,indent=0]
....
include::https://raw.githubusercontent.com/feedhenry/mobile-security-ios-template/master/secure-ios-app/services/AuthenticationService.swift[tags=isLoggedIn]
....

The `performLogout()` can be used to logout the user.

.Code
[source,swift,linenum,indent=0]
....
include::https://raw.githubusercontent.com/feedhenry/mobile-security-ios-template/master/secure-ios-app/services/AuthenticationService.swift[tags=performLogout]
....
